...
//
// Public entry point of dev.everframe:media3 (spec 2026-09-05 §3).
...
@JvmOverloads
fun Everframe.trackPlayer(player: ExoPlayer, name: String? = null): PlayerHandle {
    val facade = ExoPlayerFacade(player)
    val looperHandler = Handler(player.applicationLooper)
    return trackPlayerWith(
        facade = facade,
        name = name,
        register = { integration, n -> Everframe.trackPlayer(integration, n) },
