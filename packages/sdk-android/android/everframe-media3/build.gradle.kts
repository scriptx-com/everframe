...
//
// :everframe-media3 — Session Vitals playback tracking for Media3/ExoPlayer.
...
android {
    namespace = "dev.everframe.media3"
    kotlinOptions {
        jvmTarget = "17"
    }
    defaultConfig {
...
afterEvaluate {
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    name.set("Everframe Android — media3")
    ...
    signing {
        ...
        if (signingKey != null && signingPassword != null) {
            ...
            logger.warn("[everframe-media3] GPG signing skipped — SIGNING_KEY / SIGNING_PASSWORD not set. Local Maven publishing still works; Central Portal bundles require signatures.")
        }
    }
}

// Release-variant unit tests (mirrors :everframe-reporter-ui's identical gate).
//
...
// :everframe-core and :everframe-reporter-ui already document, same remedy:
