...
#
# :everframe-media3 CONSUMER-level R8/proguard rules — applied to the HOST
...
# :everframe-core's pair: a symbol kept at publish time but not here ships
# readable in the AAR and is renamed again in the customer's APK — which is
# exactly the shape that breaks a customer calling `Everframe.trackPlayer(...)`
