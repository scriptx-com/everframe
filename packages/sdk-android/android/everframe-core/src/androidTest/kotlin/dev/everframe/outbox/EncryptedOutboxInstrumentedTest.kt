...
class EncryptedOutboxInstrumentedTest {
    ...
    private val root get() = File(context().noBackupFilesDir, "dev.everframe/outbox-v1")
    ...
    private suspend fun reopenAndRetry(attachmentBytes: Int) {
        ...
        try {
            ...
            for (status in listOf(503, 200)) {
                ...
                assertEquals(entry.idempotencyKey, request.getHeader("X-Everframe-Idempotency-Key"))
