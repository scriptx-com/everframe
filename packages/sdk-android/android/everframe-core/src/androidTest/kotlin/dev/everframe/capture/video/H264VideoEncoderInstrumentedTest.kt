...
/** Synthetic pixels only. Controller retrieves files/video-encoder-fixture-yuv via run-as dev.everframe.test. */
class H264VideoEncoderInstrumentedTest {
    ...
    private fun runFixture(egl:Boolean) {
        ...
        try {
            ...
            Log.i("EverframeEncoderFixture",manifest.toString())
