...
Run after :everframe-core:compileReleaseKotlin. No Android device needed.
"""
import os
...
assert_inert("com/everframe/Everframe.class", "__nativeVideoDiagnostics()")
assert_inert("com/everframe/capture/replay/ReplaySession.class", "nativeVideoDiagnostics")
# The release callback must not snapshot or retain a recorder during report completion.
callbacks = list((classes / "com/everframe/capture/replay").glob("ReplaySession*.class"))
