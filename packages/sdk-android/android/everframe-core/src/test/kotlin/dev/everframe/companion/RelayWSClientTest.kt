...
class RelayWSClientTest {
    ...
    private fun minimalAssembledPayload(correlationId: String) =
        CompanionCaptureBridge.AssembledPayload(
            assembled = dev.everframe.protocol.generated.ReportAssembled(
                correlationId = correlationId,
                counts = dev.everframe.protocol.generated.ReportAssembledCounts(
                    logs = 0L, network = 0L, uiTreeNodes = 0L,
                ),
                mime = "image/png",
                size = 1L,
                toggles = dev.everframe.protocol.generated.ReportAssembledToggles(
    ...
    fun onStart_doesNotOpenSecondWebSocketWhenOneAlreadyAlive() {
        ...
        // produces the "first scan expired" symptom. See Everframe.companion
