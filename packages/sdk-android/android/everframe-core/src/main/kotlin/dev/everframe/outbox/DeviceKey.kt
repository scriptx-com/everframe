...
//
// Mirrors `packages/sdk-ios/Sources/Everframe/Outbox/DeviceKey.swift`.
//
// LOCKED (AUTH-01, T-04-19):
//   • Master key scheme: AES256_GCM (LOCKED — never weaker).
//   • File scheme: AES256_GCM_HKDF_4KB.
//   • Filename: `everframe-device-key.enc` under `Context.filesDir`.
//
...
internal object DeviceKey {
    ...
    private const val FILE_NAME: String = "everframe-device-key.enc"
     ...
     * caller (Everframe.start()'s heavy-init coroutine) wraps this in `txGuard{}`
