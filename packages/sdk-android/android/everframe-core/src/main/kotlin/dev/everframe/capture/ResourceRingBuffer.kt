...
// the lock). Without this, `Everframe.kill()` calling
...
class ResourceRingBuffer internal constructor(
     ...
     *
     * Round-review Finding 3 (2026-09-05) — gated on [Everframe.captureGate],
     ...
     * `Everframe.kill()`, which flips `captureGate` false strictly before
