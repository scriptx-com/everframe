...
// (EverframeInterceptor) records only:
...
// EverframeInterceptor.kt's sibling directory is the second belt.
...
class NetworkRingBuffer internal constructor(
     ...
     * `EverframeInterceptor.intercept` can resume from `chain.proceed()` after
     * `kill()` has already flipped `Everframe.captureGate` and zeroized this
