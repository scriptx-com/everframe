...
class VitalsCollector(private val deps: Deps) {
    ...
    private fun addEntry(
        ...
        // (Everframe/Resources): a 2-second-resolution ring attached to the
    ...
    fun stop() = txGuardVoid("VitalsCollector.stop") {
        lock.withLock {
            ...
            try {
                ...
                dev.everframe.envelope.InternalLogger.recordSafeWrapFailure("VitalsCollector.stop.finalize", t)
            } finally {
