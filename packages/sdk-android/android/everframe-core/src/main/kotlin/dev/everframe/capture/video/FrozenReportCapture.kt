...
class FrozenReportCapture internal constructor(
    ...
    fun matchesSession(session: dev.everframe.TXCapturedSession): Boolean =
    ...
    suspend fun exportVideo(): OwnedVideoClip? {
        ...
        try {
            ...
            return dev.everframe.Everframe.withReportAuthorizationLock {
    ...
    fun finishConsumption() = dev.everframe.Everframe.withReportAuthorizationLock { terminate(false) }
    fun cancel() = dev.everframe.Everframe.withReportAuthorizationLock {
