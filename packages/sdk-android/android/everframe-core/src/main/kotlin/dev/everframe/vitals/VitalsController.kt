...
internal class VitalsController(private val deps: Deps) {
    ...
    private fun startCollectorLocked(): (() -> Unit)? {
        ...
        try {
            ...
            dev.everframe.envelope.InternalLogger.recordSafeWrapFailure("VitalsController.startCollector", t)
    ...
    private inner class Ctx(
        ...
        override fun emit(type: String, data: Map<String, Any?>?, t: Long?): Boolean {
            ...
            if (type !in PlayerEventTypes.ALL) {
                dev.everframe.envelope.InternalLogger.recordSafeWrapFailure(
    ...
    private fun detachAndMark(
        ...
        try {
            ...
            dev.everframe.envelope.InternalLogger.recordSafeWrapFailure("PlayerIntegration.detach", t)
            complete()
        }
    }
