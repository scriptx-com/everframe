...
// user.
//
// Kotlin port of `packages/sdk-ios/Sources/Everframe/Config/InstallIdentifier
...
internal object InstallIdentifier {
    ...
    const val DOMAIN_SEPARATOR: String = "everframe-install-id-v1"

    /** 16 bytes -> 32 lowercase hex, same width web uses (`INSTALL_SEED_BYTES`). */
    private const val SEED_BYTES: Int = 16

    internal const val PREFS_NAME: String = "everframe-install"
