...
object NetworkBodyTee {
     ...
     *
     *  `internal` per spec §5.1: `traceitx-core` publishes as `com.traceitx:core`
     *  and `proguard-rules.pro`'s blanket `-keep class com.traceitx.capture.**`
     ...
     * (packages/sdk-ios/Sources/TraceItX/Capture/NetworkBodyCapture.swift:78).
