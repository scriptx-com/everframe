...
// port of packages/sdk-ios/Sources/TraceItX/Capture/NetworkBodyCaptureGate.swift
// (Task 8):
//
...
object NetworkBodyCaptureState {
     ...
     * [com.traceitx.okhttp.TraceItXInterceptor]'s call site for the full fix.
     */
     ...
     * `addTraceItXInterceptor()` attaches [com.traceitx.okhttp.TraceItXInterceptor]
     ...
     */
    fun locallyDisabled(config: TraceItXConfig?): Boolean {
     ...
     * correlating SHIPPED network breadcrumb — [com.traceitx.envelope.EnvelopeBuilder]
    ...
    /**
     * Production reset — called from [com.traceitx.TraceItX.kill] (final-review
     * Finding 3: process-lifetime sampling) AND, synchronously, from the
     * START of [com.traceitx.TraceItX.start] (round-5 review Finding F23:
     ...
     * packages/sdk-ios/Sources/TraceItX/Capture/NetworkBodyCaptureGate.swift's
     * `reset()`.
     */
     ...
     * [applyConfig]). Mirrors
     * [com.traceitx.capture.BreadcrumbRingBuffer.__holdLockForTesting].
     */
    @VisibleForTesting
     ...
     * [com.traceitx.capture.BreadcrumbRingBuffer.__hasQueuedThreadsForTesting].
     */
    @VisibleForTesting
