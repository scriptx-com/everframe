...
//
// Mirrors `packages/sdk-ios/Sources/TraceItX/Transport/TraceItXTransportError.swift`
// with Android idioms: data class for cases that carry payload, object for singletons.
package com.traceitx.transport

sealed class TraceItXTransportError(message: String) : Exception(message) {
