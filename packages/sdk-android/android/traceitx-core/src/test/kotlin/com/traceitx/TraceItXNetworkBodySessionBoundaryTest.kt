...
class TraceItXNetworkBodySessionBoundaryTest {

    private val context: Context get() = ApplicationProvider.getApplicationContext()
    private val configUrl = "https://traceitx.com/api/config"

    private fun validConfig(sdkKey: String): TraceItXConfig = TraceItXConfig(
        appId = "test-app-id",
        sdkKey = sdkKey,
    ...
    fun `start(B) synchronously tears down session A and resets network-body capture state`() {
        TraceItX.start(context, validConfig("txx_live_appA1234567890"))
        ...
        TraceItX._replaySession = sessionA
        ...
        TraceItX.start(context, validConfig("txx_live_appB0987654321"))
