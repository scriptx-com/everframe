...
// `:traceitx-core` test classpath and the `ReportAPIIsPresentingTest`
...
class CompanionStateTest {
    ...
    @Test
    fun `TraceItX_companion is the same singleton as Companion object`() {
        assertSame(Companion, com.traceitx.TraceItX.companion)
    }
