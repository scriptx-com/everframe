...
// been broken since 2026-05-11, so nothing in `traceitx-core/src/test` is
// gated by CI today. Run locally:
//
//     cd packages/sdk-android/android && ./gradlew :traceitx-core:testDebugUnitTest --tests 'com.traceitx.companion.*'
...
class CompanionDeviceTest {
    ...
    fun hashToUuid_knownVector() {
        ...
        // out-of-band (SHA-256("traceitx-test-vector"), first 16 bytes, byte
        ...
        val id = CompanionDeviceId.hashToUuid("traceitx-test-vector")
        assertEquals("069517e3-5bd7-4012-b70c-f7a35e011fc9", id)
    }
