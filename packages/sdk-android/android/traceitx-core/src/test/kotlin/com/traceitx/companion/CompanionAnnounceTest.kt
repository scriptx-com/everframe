...
//
//     cd packages/sdk-android/android && ./gradlew :traceitx-core:testDebugUnitTest
//
 ...
 * in `traceitx-core/build.gradle.kts`. Do not "fix" that exclusion by adding a
 * `-keep` rule.
 *
 ...
 * them, and a test that class-loads `com.traceitx.companion.CompanionAnnounce`
