...
class CompanionAttributionFlowTest {
     ...
     * `TraceItXModule.stopCompanion()` deliberately does NOT cancel in-flight
    ...
    fun aSubmitInFlightWhenTheHostRestartsCompanionForAnotherUserKeepsTheFirstUsersToken() {
        ...
        val recorded = runOneReport(
            ...
            requestAttributionToken = "attr_user_a_report",
            duringComposition = {
                // The full `TraceItXModule.stopCompanion()` teardown, including
     ...
     * `TraceItXModule.installCompanionBridgeProviders()`'s (that module is a
