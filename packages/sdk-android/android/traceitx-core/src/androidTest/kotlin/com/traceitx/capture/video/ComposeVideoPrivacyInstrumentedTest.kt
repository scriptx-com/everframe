        ...
        for (fixture in listOf("clean", "wide", "deep", "draw", "semantic-wide")) {
            ...
            rule.runOnIdle {
                ...
                repeat(30) {
                    ...
                    android.util.Log.i("TraceItXComposeBudget", "$fixture sample=$it ns=$elapsed nodes=${result.visited} classification=${result.classification}")
                }
                android.util.Log.i("TraceItXComposeBudget", "$fixture maxNs=$max budgetNs=2000000")
