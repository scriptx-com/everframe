...
//
// Reads `fixtures/canonical/minimal-envelope.json` (a canonical TraceItX envelope
// shared with the TS and Swift SDKs), deserializes via the codegen-emitted
// `ReportEnvelope` (Plan 05-02 :traceitx-protocol), re-serializes via Kotlin's
