...
//
// React Native autolinking config for @everframe/react-native.
//
// Why this file exists:
//   pnpm-workspace consumers symlink this package as
//   `node_modules/@everframe/react-native -> ../../../../packages/sdk-react-native`.
...
//   .getEnforcing('Everframe')` then throws at runtime because no native
//   module by that name was linked into the app binary.
//
// This file is the marker. The empty `platforms` blocks tell autolinking:
//   • iOS → discover via the existing `ios/Everframe.podspec` (no overrides)
