...
export default defineConfig({
  ...
  // RN codegen (Plan 06-02 iOS + Plan 06-03 Android) reads NativeTraceItX.ts
  ...
  // emitted .d.ts files keep `import … from '@traceitx/sdk-core'` /
  ...
  // the minified output. RN codegen reads NativeTraceItX.ts via dts +
  ...
  // would `import '@traceitx/sdk-core'` and fail at consumer install time.
  //
  ...
  noExternal: ["@traceitx/sdk-core", "@traceitx/protocol", "zod"],
});
