...
public extension EverframeAttachment {
    init(byteLength: Double, contentType: String, durationMS: Double?, format: EverframeFormat?,
         height: Double?, kind: EverframeAttachmentKind, partName: String, sha256: String, width: Double?) {
