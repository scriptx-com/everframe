...
// EverframeReporterUI); `ReporterSubmission` lives one module down
// (EverframeKit) and cannot see `Annotation`. This serializer is therefore
// the ONLY place shape→wire-dict knowledge lives — `Inputs.Shot` on the
// lower-module side carries only the already-serialized `[EverframeJSONAny]`
// produced here.
//
// EverframeJSONAny (EverframeProtocol/Generated.swift) has no public
...
// as `[EverframeJSONAny]`. This is the same approach `EnvelopeBuilder.toJSONAnyArray`
...
public enum AnnotationWireFormat {
    ...
    public static func serialize(
        ...
        partName: String
    ) -> (annotations: [EverframeJSONAny], redactions: [EverframeJSONAny]) {
    ...
    /// Encode a `[[String: Any]]` payload through JSON to obtain `[EverframeJSONAny]`
