...
//
// Report EverframeResource Window (spec 2026-09-05) — lock-protected FIFO ring buffer
...
// eviction horizon without an Everframe SDK restart — see ReplayConfigProvider.swift's
...
public final class ResourceRingBuffer: @unchecked Sendable {
    ...
    /// append/snapshot with no Everframe SDK restart (see ReplaySession.applyConfig).
