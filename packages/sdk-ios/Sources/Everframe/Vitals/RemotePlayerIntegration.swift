...
// sdk-android's RemotePlayerIntegration.kt. The player lives where this Everframe SDK
...
public final class RemotePlayerIntegration: PlayerIntegration, AttachRollback, @unchecked Sendable {
    ...
    /// The registry's blanket re-registration is gone; a restarted Everframe SDK is now followed by
