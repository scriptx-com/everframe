...
// TraceItX.swift — this file covers the builder-level shape contract, the
...
struct NetworkBodyEnvelopeTests {
    ...
    private func entry(ref: Double, t: Double, reqBody: String? = nil, resBody: String? = nil) -> NetworkBody {
        NetworkBody(
            ref: ref,
            reqBody: reqBody,
    ...
    private func networkCrumb(reqId: Int, seq: Int, t: Double = 1_700_000_000_000) -> Breadcrumb {
        Breadcrumb(
    ...
    @Test func envelopeEmitsBodiesAndIncludedMarker() throws {
        ...
        let (bytes, _) = try builder.buildEncoded(
            reportId: UUID(), sdkName: "traceitx-ios", sdkVersion: "t",
    ...
    // Round-6 review Finding F31: drives `TraceItX.shared` (start/kill) and
    ...
    /// the generated `NetworkBody` shape round-trips the wire format without
    ...
    @Test func parityFixtureRoundTrips() throws {
        ...
        let fixture = try JSONDecoder().decode([NetworkBody].self, from: Data(contentsOf: url))
    ...
    @Test func breadcrumbsWithoutNetworkKind_bodiesPresent_networkBodiesAbsent() throws {
        ...
        let nonNetworkCrumb = Breadcrumb(
    ...
    @Test func everyBodyMatched_allEncode_andInvariantHolds() throws {
        ...
        let shippedNetworkReqIds: [Int64] = envelope.payload.breadcrumbs?
            .filter { (b: Breadcrumb) in b.kind == .network }
