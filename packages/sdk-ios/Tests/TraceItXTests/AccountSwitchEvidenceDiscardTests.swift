...
// `TraceItX.swift`'s `setIdentityToken` for the full account and
...
// inspect what actually arrived on the wire. `TraceItX.swift` is not
...
final class AccountSwitchEvidenceDiscardTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("traceitx-account-switch-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAnAccountSwitchToADifferentVerifiedIdentityDoesNotDiscardThePreviousUsersEvidence() async throws {
        ...
        let sentToken = recorded.headers["X-TX-Identity-Token"]
    ...
    /// Fix round 1, IMPORTANT 2 (Report Resource Window, spec 2026-09-05) —
