...
final class JSONLOutboxTests: XCTestCase {
    ...
    /// (Library/Caches/com.traceitx) is never touched.
    private var tempDir: URL!

    override func setUpWithError() throws {
        try super.setUpWithError()
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("traceitx-outbox-tests-\(UUID().uuidString)", isDirectory: true)
    ...
    func test_encrypted_queue_uses_after_first_unlock_file_protection() throws {
        ...
        XCTAssertTrue(stored.starts(with: Data("TXOBX001".utf8)))
