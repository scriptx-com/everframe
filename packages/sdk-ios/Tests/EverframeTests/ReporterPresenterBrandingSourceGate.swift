...
// presentation wiring in EFReporterPresenter.swift, which is UIKit-gated and
...
final class EFReporterPresenterBrandingSourceGate: XCTestCase {
    ...
    func testPresenterResolvesThemeAndWatermarkFromTheServerBox() throws {
        ...
        XCTAssertNotNil(
            ...
            """
            EFReporterPresenter.swift no longer snapshots BrandingServerConfigBox.shared.value at \
        ...
        XCTAssertNotNil(
            ...
            """
            EFReporterPresenter.swift no longer derives the watermark from \
        ...
        XCTAssertNotNil(
            ...
            """
            EFReporterPresenter.swift no longer resolves the palette via \
