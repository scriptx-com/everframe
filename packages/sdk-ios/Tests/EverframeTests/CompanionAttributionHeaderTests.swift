...
// `X-Everframe-Companion-Attribution` (spec 2026-08-07) — that header is the only
...
struct CompanionAttributionHeaderTests {
    ...
    @Test func companionSubmit_sendsTheAttributionHeader() async throws {
        ...
        let header = CompanionAttrStubURLProtocol.capturedRequest?
            .value(forHTTPHeaderField: "X-Everframe-Companion-Attribution")
    ...
    @Test func ordinarySubmit_sendsNoAttributionHeader() async throws {
        ...
        #expect(captured != nil)
        #expect(captured?.value(forHTTPHeaderField: "X-Everframe-Companion-Attribution") == nil)
...
@Suite struct CompanionAttributionHeaderTests_CompanionCaptureBridgeSourceGate {
    ...
    /// `<package root>/Sources/Everframe/Companion/CompanionCaptureBridge.swift`,
    ...
    private static func bridgeSource() throws -> String {
        ...
        // …/Tests/EverframeTests/ThisFile.swift → …/
        let packageRoot = thisFile
            .deletingLastPathComponent()   // EverframeTests
            .deletingLastPathComponent()   // Tests
            .deletingLastPathComponent()   // package root
        let bridge = packageRoot
            .appendingPathComponent("Sources/Everframe/Companion/CompanionCaptureBridge.swift")
    ...
    @Test func bridgeJoinsTheAttributionTokenOntoReporterSubmissionInputs() throws {
        ...
        #expect(
            ...
            report reaches ingest with no X-Everframe-Companion-Attribution header and \
    ...
    @Test func bridgeSnapshotsTheTokenIntoTheCaptureStashAtRequestTime() throws {
        ...
        #expect(
            ...
            `.everframeCompanionReportRequested` observer. The snapshot must \
    ...
    @Test func bridgeDoesNotReadTheLiveClientWhenComposingASubmit() throws {
        ...
        #expect(
            ...
            the `.everframeCompanionReportRequested` observer. A second read — \
