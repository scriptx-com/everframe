...
final class CrashReporterTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("everframe-crash-tests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testHandledCaptureKeepsBundleAndEntrySnapshotAcrossLaterContextChanges() throws {
        ...
        XCTAssertEqual((envelope["sdk"] as? [String: Any])?["name"] as? String, "everframe-react-native")
    ...
    func testNonfatalDrainCanBeAwaitedAndKeepsRetryIdentityOnLocalFailure() async throws {
        ...
        guard IngestEndpoint.url.absoluteString == "http://127.0.0.1:9" else {
            XCTFail("Run with EVERFRAME_DEV_INGEST_URL=http://127.0.0.1:9 before starting XCTest")
            return
        }
    ...
    func testFingerprintMatchesCrossSDKFixture() throws {
        ...
        // instead: Tests/EverframeTests/CrashReporterTests.swift -> up 3 to
    ...
    func testBreadcrumbSnapshotIsNonDestructive() {
        // honorsKillGate: false — bypasses Everframe.shared.captureGate (which
