...
final class VitalsFixtureParityTests: XCTestCase {
    ...
    /// before the budget was taught JavaScript's number formatting the Everframe SDK sent it whole and
    /// ingest rejected the WHOLE chunk. Regenerating this fixture from that Everframe SDK would produce a
