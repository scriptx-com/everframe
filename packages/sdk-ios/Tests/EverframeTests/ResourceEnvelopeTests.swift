...
//
// Report EverframeResource Window (spec 2026-09-05) — `payload.resources` on the
...
final class ResourceEnvelopeTests: XCTestCase {
    ...
    func testCrashEnvelopeCarriesResourcesFromTheSharedRing() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("everframe-resource-envelope-tests-\(UUID().uuidString)", isDirectory: true)
