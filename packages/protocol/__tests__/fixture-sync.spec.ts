...
// the iOS Tests/Fixtures and Android everframe-protocol/src/test/resources
...
const groups = [
  {
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/crash-causes.json`,
      `${HERE}/../../sdk-android/android/everframe-protocol/src/test/resources/crash-causes.json`,
    ],
  },
  {
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/jvm-crash-envelope.json`,
      `${HERE}/../../sdk-android/android/everframe-protocol/src/test/resources/jvm-crash-envelope.json`,
    ],
  },
  {
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/crash-report-hermes.json`,
      `${HERE}/../../sdk-android/android/everframe-protocol/src/test/resources/crash-report-hermes.json`,
    ],
  },
  {
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/v1-cross-sdk-proto-02.json`,
      `${HERE}/../../sdk-android/android/everframe-protocol/src/test/resources/v1-cross-sdk-proto-02.json`,
    ],
  },
  {
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/crash-report.json`,
      `${HERE}/../../sdk-android/android/everframe-protocol/src/test/resources/crash-report.json`,
    ],
  },
  {
    ...
    // everframe-core (not everframe-protocol) — that's where its consumer is.
    name: 'network-bodies.v1.json',
    canonical: `${HERE}/fixtures/network-bodies.v1.json`,
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/network-bodies.v1.json`,
      `${HERE}/../../sdk-android/android/everframe-core/src/test/resources/network-bodies.v1.json`,
    ],
  },
  {
    ...
    // Android copy lives under everframe-core (not everframe-protocol) — that's
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/identity-token-native.v1.json`,
      `${HERE}/../../sdk-android/android/everframe-core/src/test/resources/identity-token-native.v1.json`,
    ],
  },
  {
    ...
    // everframe-core (not everframe-protocol) — that's where InstallIdentifier
    ...
    siblings: [
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/install-id.v1.json`,
      `${HERE}/../../sdk-android/android/everframe-core/src/test/resources/install-id.v1.json`,
    ],
  },
  {
    // Android session vitals (spec 2026-09-05). Decoded by
    // vitals-android-fixture.spec.ts (TS) and VitalsFixtureParityTest (Kotlin,
    // under everframe-core — that's where the wire types live).
    name: 'vitals-android.v1.json',
    canonical: `${HERE}/fixtures/vitals-android.v1.json`,
    siblings: [
      `${HERE}/../../sdk-android/android/everframe-core/src/test/resources/vitals-android.v1.json`,
    ],
  },
  {
    ...
    siblings: [`${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/vitals-ios.v1.json`],
  },
  {
    ...
    siblings: [
      `${HERE}/../../sdk-android/android/everframe-core/src/test/resources/vitals-rn-bridge.v1.json`,
      `${HERE}/../../sdk-ios/Tests/EverframeTests/Fixtures/vitals-rn-bridge.v1.json`,
    ],
  },
];
