...
//
// Ingest URL is baked into @traceitx/react at its build time (tsup
// `define` substitutes the `__TRACEITX_INGEST_URL__` placeholder). For local
// dev, build sdk-react with `TRACEITX_INGEST_URL=http://localhost:8787` then
