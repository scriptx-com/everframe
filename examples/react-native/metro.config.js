...
//
// Metro config for the @traceitx/react-native dogfood sample (Plan 06-06).
//
// pnpm workspace integration:
//
//   - watchFolders hoists the workspace `packages/` tree so Metro re-bundles
//     when @traceitx/react-native (or any sibling) changes.
...
//     consuming packages via `node_modules/@traceitx/foo`).
...
//   - extraNodeModules explicitly maps the workspace `@traceitx/*` packages
...
//     This is the canonical fix for the "@traceitx/react could not be
//     found" failure when bundling @traceitx/react-native (which imports
...
config.resolver.extraNodeModules = {
  ...
  '@traceitx/react-native': path.resolve(workspaceRoot, 'packages/sdk-react-native'),
  '@traceitx/react': path.resolve(workspaceRoot, 'packages/sdk-react'),
  '@traceitx/sdk-core': path.resolve(workspaceRoot, 'packages/sdk-core'),
  '@traceitx/protocol': path.resolve(workspaceRoot, 'packages/protocol'),
